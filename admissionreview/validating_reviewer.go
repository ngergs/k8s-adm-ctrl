...
type ValidatingReviewer struct {
	// Validator holds the actual object validation logic
...
func (reviewer *ValidatingReviewer) Review(arRequest *admissionv1.AdmissionRequest) *admissionv1.AdmissionResponse {
	result := reviewer.Validator.Validate(&arRequest.Kind, arRequest.Object.Raw[:])
